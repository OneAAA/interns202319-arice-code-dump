...
u = mda.Universe("full-out-topol.lammpstrj", "LiClH2O-250K.lammpstrj", topology_format="LAMMPSDUMP", format="LAMMPSDUMP")
print("Selecting Lis")
...
print("Running LiLi")
rdfLiLi.run(start, stop)
print("Running LiCl")
rdfLiCl.run(start, stop)
print("Running ClCl")
rdfClCl.run(start, stop)
print("Running LiO")
rdfLiO.run(start, stop)
print("Running ClO")
rdfClO.run(start, stop)
...
file_dump = open("data-250K-rdf.data", 'wb')
